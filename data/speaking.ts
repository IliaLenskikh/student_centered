...
export const speakingStories: Story[] = [
  {
    "title": "The Pacific Ocean",
    "speakingType": "read-aloud",
    "template": [], 
    "tasks": [], 
